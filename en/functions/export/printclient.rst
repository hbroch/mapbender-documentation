...
Users have the option to print their name. In order to do so, they have to insert **user_name** into their print template. The logged-in user's name is then printed at the defined location. If no user is logged in, nothing is printed. 
